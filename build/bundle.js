...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Edit = __webpack_require__(227);
	...
	exports.default = _react2.default.createClass({
	    ...
	    editHandle: function editHandle(index) {
	        var list = this.state.list;
	        return function () {
	    ...
	    render: function render() {
	        ...
	        switch (this.state.type) {
	            case "add":
	                sec = _react2.default.createElement(_Add2.default, { nSave: this.saveHandle() });
	                break;
	            case "save":
	                sec = _react2.default.createElement(_Home2.default, { editNote: this.editHandle, delNote: this.delHandle, note: noteList.note });
	                break;
	            case "edit":
	                sec = _react2.default.createElement(_Edit2.default, { defaultVal: noteList.note[s], nSave: this.saveHandle() });
	                break;
	            default:
	        ...
	        return _react2.default.createElement(
	            'div',
	            { className: 'container' },
	            _react2.default.createElement(_Header2.default, { nClick: this.addHandle() }),
	            sec
	        );
	    }
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _NoteItem = __webpack_require__(224);
	...
	exports.default = _react2.default.createClass({
	    ...
	    render: function render() {
	        ...
	        return _react2.default.createElement(
	            'section',
	            { className: 'listnotes left-transition' },
	            note.map(function (k, v) {
	                return _react2.default.createElement(_NoteItem2.default, { editNote: that.props.editNote(v), delNote: that.props.delNote(v), data: k, key: v });
	            })
	        );
	    }
	}); /**
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createClass({
	    ...
	    render: function render() {
	        ...
	        return _react2.default.createElement(
	            'div',
	            { className: 'listnotes__note' },
	            _react2.default.createElement('span', { className: 'listnotes__note--edit', onClick: this.props.editNote }),
	            _react2.default.createElement('span', { className: 'listnotes__note--close', onClick: this.props.delNote }),
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement('input', { className: 'header__searchbox--input', type: 'text', placeholder: 'search your notes' })
	            ),
	            _react2.default.createElement(
	                'div',
	                { className: 'header__btngroup' },
	                _react2.default.createElement(
	                    'button',
	                    { className: 'header__btngroup--new v-link-active', type: 'button', onClick: this.props.nClick },
	                    'New'
	                )
	            )
	        );
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createClass({
	    displayName: 'Add',
	    saveChangeHandle: function saveChangeHandle() {
	        this.props.nSave(this.refs.Addtitle.value, this.refs.Addcontent.value);
	    },
	    render: function render() {
	        return _react2.default.createElement(
	            'section',
	            { className: 'createnote left-transition' },
	            _react2.default.createElement(
	                'div',
	                { className: 'createnote__field' },
	                _react2.default.createElement('input', { ref: 'Addtitle', type: 'text', className: 'createnote__field--title', placeholder: 'Title note' }),
	                _react2.default.createElement('textarea', { ref: 'Addcontent', className: 'createnote__field--text', placeholder: 'This is my note written in Markdown' }),
	                _react2.default.createElement(
	                    'button',
	                    { className: 'header__btngroup--save v-link-active', type: 'button', onClick: this.saveChangeHandle },
	                    'Save'
	                )
	            )
	        );
	    ...
	    render: function render() {
	        ...
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                'div',
	                { className: 'createnote__field' },
	                _react2.default.createElement('input', { ref: 'Addtitle', defaultValue: defaultVal.title, type: 'text', className: 'createnote__field--title', placeholder: 'Title note' }),
	                _react2.default.createElement('textarea', { ref: 'Addcontent', defaultValue: defaultVal.content, className: 'createnote__field--text', placeholder: 'This is my note written in Markdown' }),
	                _react2.default.createElement(
	                    'button',
	                    { className: 'header__btngroup--save v-link-active', type: 'button', onClick: this.saveChangeHandle },
	                    'Save'
